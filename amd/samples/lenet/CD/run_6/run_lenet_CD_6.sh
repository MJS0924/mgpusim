...
../../lenet \
    ...
    -per-window-output=/root/mgpusim_home/results/per_window/lenet/lenet_CD_6_per_window.csv \
    -mem-latency-trace \
    -mem-latency-trace-output=/root/mgpusim_home/results/mem_path/lenet/lenet_CD_6_mem_path.csv \
    -report-all \
