...
cd /root/mgpusim_home/mgpusim/amd/samples/im2col/ablation/a6_9banks

export EVENT_LOG_PATH=/root/mgpusim_home/results_ablation/A6_nbank/9banks/rawdata/events/im2col_a6_9banks_events.parquet
...
mv akita_sim_*.sqlite3 /root/mgpusim_home/results_ablation/A6_nbank/9banks/rawdata/sql/im2col_a6_9banks.sqlite3 2>/dev/null
