...
cd /root/mgpusim_home/mgpusim/amd/samples/matrixmultiplication/ablation/a5_log2_1

export EVENT_LOG_PATH=/root/mgpusim_home/results_ablation/A5_log2sweep/log2_1/rawdata/events/matrixmultiplication_a5_log2_1_events.parquet
...
mv akita_sim_*.sqlite3 /root/mgpusim_home/results_ablation/A5_log2sweep/log2_1/rawdata/sql/matrixmultiplication_a5_log2_1.sqlite3 2>/dev/null
