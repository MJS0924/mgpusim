...
cd /root/mgpusim_home/mgpusim/amd/samples/minerva/CD/run_0
...
../../minerva \
    ...
    -mem-latency-trace \
    -mem-latency-trace-output=/root/mgpusim_home/results/mem_path/minerva/minerva_CD_0_mem_path.csv \
    -report-all \
    > /root/mgpusim_home/results/CD/rawdata/text/minerva_CD_0.txt

# 결과 파일(SQLite) 이동 및 이름 변경
mv akita_sim_*.sqlite3 /root/mgpusim_home/results/CD/rawdata/sql/minerva_CD_0.sqlite3 2>/dev/null
