...
cd /root/mgpusim_home/mgpusim/amd/samples/minerva/coalescability
...
mv akita_sim_*.sqlite3 /root/mgpusim_home/results/coalescability/rawdata/sql/minerva_coalescability.sqlite3 2>/dev/null
