...
cd /root/mgpusim_home/mgpusim/amd/samples/stencil2drelu/HMG
...
mv akita_sim_*.sqlite3 /root/mgpusim_home/results/HMG/rawdata/sql/stencil2drelu_HMG.sqlite3 2>/dev/null
