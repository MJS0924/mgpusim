...
var c = flag.Int("C", 3, "input channels")
var h = flag.Int("H", 8192, "input height")
var w = flag.Int("W", 8192, "input width")
var outputC = flag.Int("output-channel", 3, "output channels")
var kernelHeight = flag.Int("kernel-height", 7, "kernel height")
var kernelWidth = flag.Int("kernel-width", 7, "kernel width")
