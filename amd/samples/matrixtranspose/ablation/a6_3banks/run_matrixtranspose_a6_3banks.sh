...
cd /root/mgpusim_home/mgpusim/amd/samples/matrixtranspose/ablation/a6_3banks

export EVENT_LOG_PATH=/root/mgpusim_home/results_ablation/A6_nbank/3banks/rawdata/events/matrixtranspose_a6_3banks_events.parquet
...
mv akita_sim_*.sqlite3 /root/mgpusim_home/results_ablation/A6_nbank/3banks/rawdata/sql/matrixtranspose_a6_3banks.sqlite3 2>/dev/null
