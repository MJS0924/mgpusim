...
cd /root/mgpusim_home/mgpusim/amd/samples/matrixtranspose/ablation/a5_log2_8

export EVENT_LOG_PATH=/root/mgpusim_home/results_ablation/A5_log2sweep/log2_8/rawdata/events/matrixtranspose_a5_log2_8_events.parquet
...
mv akita_sim_*.sqlite3 /root/mgpusim_home/results_ablation/A5_log2sweep/log2_8/rawdata/sql/matrixtranspose_a5_log2_8.sqlite3 2>/dev/null
