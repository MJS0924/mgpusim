...
export EVENT_LOG_PATH=/root/mgpusim_home/results_ablation/A0_no_promote_at_evict/rawdata/events/matrixtranspose_a0_events.parquet
...
mv akita_sim_*.sqlite3 /root/mgpusim_home/results_ablation/A0_no_promote_at_evict/rawdata/sql/matrixtranspose_a0.sqlite3 2>/dev/null
