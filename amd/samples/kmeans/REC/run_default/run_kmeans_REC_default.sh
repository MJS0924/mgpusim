...
cd /root/mgpusim_home/mgpusim/amd/samples/kmeans/REC/run_default
...
mv akita_sim_*.sqlite3 /root/mgpusim_home/results/REC/rawdata/sql/kmeans_REC.sqlite3 2>/dev/null
