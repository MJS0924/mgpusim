...
cd /root/mgpusim_home/mgpusim/amd/samples/spmv/ablation/a3

export EVENT_LOG_PATH=/root/mgpusim_home/results_ablation/A3_no_promote_at_evict/rawdata/events/spmv_a3_events.parquet
...
mv akita_sim_*.sqlite3 /root/mgpusim_home/results_ablation/A3_no_promote_at_evict/rawdata/sql/spmv_a3.sqlite3 2>/dev/null
