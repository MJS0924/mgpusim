...
cd /root/mgpusim_home/mgpusim/amd/samples/stencil2d/REC/run_default
...
mv akita_sim_*.sqlite3 /root/mgpusim_home/results/REC/rawdata/sql/stencil2d_REC.sqlite3 2>/dev/null
